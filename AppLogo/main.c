...
#elif defined(CONFIG_MAC_BES7100)
#include "logo_bes7100.dat"
#elif defined(CONFIG_MAC_ND800)
#include "logo_nd800.dat"
#elif defined(CONFIG_MAC_ASKMI1388)
#include "logo_askmi1388.dat"
#elif defined(CONFIG_MAC_NP1680)
#include "logo_nd800.dat"
#elif defined(CONFIG_MAC_BDS6100) || defined(CONFIG_MAC_BDS6100A)
#include "logo_bds6100.dat"
#elif defined(CONFIG_MAC_BDS7100)
#include "logo_bds7100.dat"
#elif defined(CONFIG_ARCH_XBURST)
#include "logo_xburst.dat"
#else
...
static int cbTaskLogo(PMESSAGE msg)
{
	...
	case WM_PAINT:
		...
		// 清除屏幕
		SetColor(hdc, COLOR_WHITE);
		FillRect(hdc, 0, 0, WND_XSIZE, WND_YSIZE);
		
		// 显示加载画面
#if defined(CONFIG_MAC_BDS6100) || defined(CONFIG_MAC_BDS6100A)
#if !defined(CONFIG_ARCH_XBURST)

		DrawBmpData(hdc, (WND_XSIZE - 180)>>1, (WND_YSIZE - 35)>>1, logo->LzwObj.out.base);

#else
		DrawJpegData(hdc, (WND_XSIZE - 180)>>1, (WND_YSIZE - 35)>>1, SmartLogo);
#endif
#else
#if !defined(CONFIG_ARCH_XBURST)
...
#else
		DrawJpegData(hdc, 0, 0, SmartLogo);
#endif
#endif
...
#elif defined(CONFIG_MAC_ET580) || defined(CONFIG_MAC_NE350) || defined(CONFIG_MAC_NE360) || defined(CONFIG_MAC_NP7000) || defined(CONFIG_MAC_ND800) || defined(CONFIG_MAC_NP1680) || defined(CONFIG_MAC_ASKMI1388)
		if(logo->sd_test_flag)
