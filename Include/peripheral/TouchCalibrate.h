...
// 5点矫正算法
int TouchCal5Matrix(PTOUCH_POINT lcd, PTOUCH_POINT touch, PTOUCH_MATRIX matrix);
int TouchCal5GetPoint(PTOUCH_POINT lcd, PTOUCH_POINT touch, PTOUCH_MATRIX matrix);
