 ...
 * Intp p0 init
 --------------------------------------------------*/
#define TCSM0_DATA_BUF  TCSM0_BANK0 + (100 << 2)

#define TCSM0_DES_MAX_Y_LEN       (1280)
#define TCSM0_DES_MAX_UV_LEN      (640)
#define DDMA_TCSM0_DES_CHAIN_LEN  ((4*3)<<2)
#define DDMA_TCSM0_DES_CHAIN      (TCSM0_BANK3)
#define TCSM0_DEST_YBUF1          (DDMA_TCSM0_DES_CHAIN + DDMA_TCSM0_DES_CHAIN_LEN)
#define TCSM0_DEST_UBUF1          (TCSM0_DEST_YBUF1 + TCSM0_DES_MAX_Y_LEN*2)
#define TCSM0_DEST_VBUF1          (TCSM0_DEST_UBUF1 + TCSM0_DES_MAX_UV_LEN)
