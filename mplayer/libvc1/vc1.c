...
void motion_config_vc1(VC1Context *v)
{
  ...
  //write_reg( (MOTION_V_BASE+REG1_TAP1M), 0x0);
  //write_reg( (MOTION_V_BASE+REG1_TAP1L), 0x0);
  //write_reg( (MOTION_V_BASE+REG1_TAP2M), 0x0);
  //write_reg( (MOTION_V_BASE+REG1_TAP2L), 0x0);
