...
typedef struct H264Context{
  ...
  //DECLARE_ALIGNED(8, uint8_t, direct_slim_cache)[4*3];
    DECLARE_ALIGNED(8, int8_t, direct_slim_cache)[4*3];
    int8_t intra4x4_pred_mode_cache[5*8];
  //int8_t (*intra4x4_pred_mode);
    int8_t (*intra4x4_pred_mode)[8];//60 formate

    int *top_intra4x4_pred_mode;
    ...
    */
#ifdef JZC_DCORE_OPT
    uint16_t nnz_top_left;
    uint16_t *nnz_bottom_right_table;
#endif
...
#define PART_NOT_AVAILABLE -2
  ...
  //60 formate; it should be accorded with  slice_table_base 
...
//=============================================================
  ...
  //uint16_t *slice_table_base;
    uint8_t *slice_table_base; //60 formate, it should be accorded with slice_table
