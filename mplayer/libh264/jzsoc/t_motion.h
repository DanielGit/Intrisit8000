...
#define BINFO_EXPDY_MSK     0x3F
#define BINFO_EXPDX_SFT     18
#define BINFO_EXPDX_MSK     0x3F
...
#define TDD_CH1PEL_SFT     28
#define TDD_CH1PEL_MSK     0x1
#define TDD_CH2PEL_SFT     26
#define TDD_CH2PEL_MSK     0x3
#define TDD_POSMD_SFT      25
#define TDD_POSMD_MSK      0x1
#define TDD_MVMD_SFT       24
#define TDD_MVMD_MSK       0x3
#define TDD_CH2EN_SFT      23
#define TDD_CH2EN_MSK      0x1
...
#define TDD_HEAD(vld, lk, sync, ch1pel, ch2pel, posmd, mvmd,	 \
		 ch2en, tkn, mby, mbx)				 \
  ( (((vld) & TDD_VLD_MSK)<<TDD_VLD_SFT) |			 \
    (((lk) & TDD_LK_MSK)<<TDD_LK_SFT) |				 \
    (((sync) & TDD_SYNC_MSK)<<TDD_SYNC_SFT) |			 \
    ...
    (((ch2en) & TDD_CH2EN_MSK)<<TDD_CH2EN_SFT) |		 \
...
#define SET_TAB1_RLUT_ROA(idx,roa)				\
  ({write_reg( (MOTION_V_BASE+TAB1_RLUT+(idx)*8+4), (roa) );		\
  })
#define SET_TAB2_RLUT_ROA(idx,roa)		\
  ({ write_reg( (MOTION_V_BASE+TAB2_RLUT+(idx)*8+4), (roa) );		\
  })


#define SET_TAB1_RLUT_WCOEF(idx,wcoef,wofst)				\
  ({ write_reg( (MOTION_V_BASE+TAB1_RLUT+(idx)*8),			\
		(((wcoef ) & RLUT_WCOEF1_MSK)<<RLUT_WCOEF1_SFT) |	\
		(((wofst ) & RLUT_WOFST1_MSK)<<RLUT_WOFST1_SFT) );	\
  })
#define SET_TAB2_RLUT_WCOEF(idx,wcoef2,wofst2,wcoef1,wofst1)		\
  ({ write_reg( (MOTION_V_BASE+TAB2_RLUT+(idx)*8),			\
		(((wcoef2) & RLUT_WCOEF2_MSK)<<RLUT_WCOEF2_SFT) |	\
		(((wofst2) & RLUT_WOFST2_MSK)<<RLUT_WOFST2_SFT) |	\
		(((wcoef1) & RLUT_WCOEF1_MSK)<<RLUT_WCOEF1_SFT) |	\
