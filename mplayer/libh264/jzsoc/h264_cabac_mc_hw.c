...
static void motion_task_cabac(H264_Slice_GlbARGs *SLICE_T, H264_MB_Ctrl_DecARGs *dmb, int mv_n, 
		 int i8x8,
		 int *tdd, int *tkn, 
		 int list0, int list1,
		 int blkh, int blkw,
...
static void motion_execute_cabac(H264_Slice_GlbARGs *SLICE_T, H264_MB_Ctrl_DecARGs *dmb, uint8_t *motion_dha)
{
